...
var
  GStyleManagerNotification: TStyleManagerNotification;

function StyleManagerNotification: TStyleManagerNotification;
begin
  if GStyleManagerNotification = nil then
    GStyleManagerNotification := TStyleManagerNotification.Create(nil);
  Result := GStyleManagerNotification;
end;
...
begin
  ...
  FSelections.Free;
  FreeAndNil(GStyleManagerNotification);
end;
