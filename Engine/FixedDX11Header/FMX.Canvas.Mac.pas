...
type
  ...
  protected
    /// <summary>Helper method that convert CGImageRef to TBitmapSurface. If sie of image is bigger than MaxSize
  ...
  protected
    ...
    /// <summary>Initialze Canvas for form.</summary>
    ...
    /// <summary>Fill epplise using ABrush settings.</summary>
