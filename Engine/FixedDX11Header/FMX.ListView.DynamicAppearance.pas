...
type
  TAppearanceObjectItemCollectionEx = class(TAppearanceObjectItemCollection)
  public
...
begin
  ...
  FObjectsCollection := TAppearanceObjectItemCollectionEx.Create(Owner, Self);
...
{ TAppearanceObjectItemCollectionEx }

procedure TAppearanceObjectItemCollectionEx.BeginUpdate;
begin
  inherited;
  FDynamicAppearance.BeginUpdate;
end;

procedure TAppearanceObjectItemCollectionEx.EndUpdate;
begin
  inherited;
