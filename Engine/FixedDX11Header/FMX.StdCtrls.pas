...
uses
  ...
  {$IFDEF MSWINDOWS}, FMX.Switch.Win{$ENDIF};
...
begin
  inherited;
  if ([csLoading, csDestroying] * ComponentState = []) and not Released and
...
begin
  ...
  begin
    ...
    begin
      SetNewValue(FPushedValue);
      if not Tracking then
        ObserversValueUpdate;
      FPushedTimer.Release;
    end
    else
    begin
