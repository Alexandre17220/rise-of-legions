...
var
  ...
  begin
    ...
    TopLeft := AItem.ParentControl.AbsoluteToLocal(Content.LocalToAbsolute(
      TPointF.Create(OffsetX + AItem.Margins.Left, CurY + AItem.Margins.Top)));
...
begin
  ...
  begin
    ...
    begin
      ...
      FDragItem.DragEnter(Data, FDragItem.AbsoluteToLocal(LocalToAbsolute(Point)));
...
begin
  ...
  begin
    ...
    DestItem.DragDrop(Data, DestItem.AbsoluteToLocal(LocalToAbsolute(Point)))
  else
  ...
  begin
    ...
    try
      ...
      begin
        ...
        begin
          P := ContentLayout.AbsoluteToLocal(FSelected.LocaltoAbsolute(TPointF.Zero));
          if P.Y < 0 then
