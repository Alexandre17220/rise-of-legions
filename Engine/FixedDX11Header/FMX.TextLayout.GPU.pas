...
*)
  ...
  TGPULine = class(TObjectList<TGPURun>)
  private
    FHeight: Single;
    FWidth: Single;
    FTopLeft: TPointF;
  ...
  TGPUFrame = class(TObjectList<TGPULine>)
  private
    FHeight: Single;
    FWidth: Single;
    FTopLeft: TPointF;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (LRun.ImageRect.Width > 0) and (WordWrap or (Trimming <> TTextTrimming.None)) and ((LLine.Width + Rec.Glyph.Advance * FScaleFactor) > WidthLimit) then
          begin
            if WordWrap then
            begin
